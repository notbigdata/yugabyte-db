...
CatalogManager::CatalogManager(Master* master)
    : master_(master),
      ...
      table_creation_manager_(std::make_unique<TableCreationManager>(this)),
...
TableInfoByNameMap& CatalogManager::table_info_by_name_map() const {
  return table_names_map_;
}
