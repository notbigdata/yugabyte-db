...
string(REGEX REPLACE "[.](so|dylib)$" ".a" CURL_LIBRARIES_STATIC "${CURL_LIBRARIES}")
ADD_THIRDPARTY_LIB(curl STATIC_LIB "${CURL_LIBRARIES_STATIC}" SHARED_LIB "${CURL_LIBRARIES}")
...
string(REGEX REPLACE "[.](so|dylib)$" ".a" ICU_I18N_LIBRARIES_STATIC "${ICU_I18N_LIBRARIES}")
...
message("ICU_I18N_LIBRARIES_STATIC=${ICU_I18N_LIBRARIES_STATIC}")

message("ICU_UC_LIBRARIES=${ICU_UC_LIBRARIES}")
message("ICU_UC_LIBRARIES_STATIC=${ICU_UC_LIBRARIES_STATIC}")
...
ADD_THIRDPARTY_LIB(icudata
  ...
  SHARED_LIB "${ICU_DATA_LIBRARIES}")
ADD_THIRDPARTY_LIB(icui18n
  STATIC_LIB "${ICU_I18N_LIBRARIES_STATIC}"
  SHARED_LIB "${ICU_I18N_LIBRARIES}")
ADD_THIRDPARTY_LIB(icuuc
  STATIC_LIB "${ICU_UC_LIBRARIES_STATIC}"
